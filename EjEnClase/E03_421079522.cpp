...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//cubo ventana central izquierda
		model = glm::mat4(1.0);
		model = glm::rotate(model, glm::radians(mainWindow.getrotay()), glm::vec3(0.0f, 1.0f, 0.0f));  //al presionar la tecla Y se rota sobre el eje y
		model = glm::translate(model, glm::vec3(-0.4f, -0.5f, -2.5f));
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.01f));
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		//model = glm::rotate(model, glm::radians(angulo), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		//cubo ventana lateral2 izquierda
		model = glm::mat4(1.0);
		model = glm::rotate(model, glm::radians(mainWindow.getrotay()), glm::vec3(0.0f, 1.0f, 0.0f));  //al presionar la tecla Y se rota sobre el eje y
		model = glm::translate(model, glm::vec3(1.0f, -0.5f, -2.8));
		model = glm::scale(model, glm::vec3(0.01f, 0.2f, 0.2f));
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		//model = glm::rotate(model, glm::radians(angulo), glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		...
		//cubo ventana lateral1 izquierda
		model = glm::mat4(1.0);
		model = glm::rotate(model, glm::radians(mainWindow.getrotay()), glm::vec3(0.0f, 1.0f, 0.0f));  //al presionar la tecla Y se rota sobre el eje y
		model = glm::translate(model, glm::vec3(-1.0f, -0.5f, -3.2f));
		model = glm::scale(model, glm::vec3(0.01f, 0.2f, 0.2f));
		...
		//cubo ventana lateral1 derecha
		model = glm::mat4(1.0);
		model = glm::rotate(model, glm::radians(mainWindow.getrotay()), glm::vec3(0.0f, 1.0f, 0.0f));  //al presionar la tecla Y se rota sobre el eje y
		model = glm::translate(model, glm::vec3(-1.0f, -0.5f, -2.8f));
		model = glm::scale(model, glm::vec3(0.01f, 0.2f, 0.2f));
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		//model = glm::rotate(model, glm::radians(angulo), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		model = glm::scale(model, glm::vec3(2.4f, 1.0f, 1.5f));
