...
void CrearTriangulo()
{
	...
	GLfloat vertices[] = {
		...
		-0.86f,-0.3f,0.0f,
		-0.86f,0.3f, 0.0f,
		-0.79f, 0.0f,0.0f, //centro de la M
		-0.86f,0.0f,0.0f,
		-0.79f, 0.0f,0.0f,
		-0.86f,0.0f,0.0f,
		-0.79f, -0.3f,0.0f,
...
int main()
{
	...
	while (!glfwWindowShouldClose(mainWindow))
	{
		...
		glDrawArrays(GL_TRIANGLES, 0, 60);//determina que es lo que voy a dibujar
		glBindVertexArray(0);
