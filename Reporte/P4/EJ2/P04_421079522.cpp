...
int main()
{
	...
	CrearCilindro(250, 1.0f);//índice 2 en MeshList
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.0f, 0.0f, 1.0f)); // Rotar la pata con F
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(2.25f, -2.8f, -2.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 0.0f, 1.0f)); // Rotar la pata con J
		model = glm::scale(model, glm::vec3(1.5f, 3.0f, 0.4f)); // Escalar la pata
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.8f, 0.8f, 0.8f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		//model = modelaux;
		model = glm::translate(model, glm::vec3(0.5f, -0.5f, -1.0f));
		//model = glm::rotate(model, glm::radians(mainWindow.getarticulacion9()), glm::vec3(0.0f, 0.0f, 1.0f)); // Nueva articulación para rotar el pie
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.5f, 1.0f, 0.3f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.8f, 0.8f);
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(-2.25f, -2.8f, 2.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion6()), glm::vec3(0.0f, 0.0f, 1.0f)); // Rotar la pata con K
		model = glm::scale(model, glm::vec3(1.5f, 3.0f, 0.4f)); // Escalar la pata
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.8f, 0.8f, 0.8f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		// Pie 3
		model = glm::translate(model, glm::vec3(0.5f, -0.5f, 1.0f));
		//model = glm::rotate(model, glm::radians(mainWindow.getarticulacion10()), glm::vec3(0.0f, 0.0f, 1.0f)); // Nueva articulación para rotar el pie
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.5f, 1.0f, 0.3f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.8f, 0.8f);
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(2.25f, -2.8f, 2.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion7()), glm::vec3(0.0f, 0.0f, 1.0f)); // Rotar la pata con M
		model = glm::scale(model, glm::vec3(1.5f, 3.0f, 0.4f)); // Escalar la pata
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.8f, 0.8f, 0.8f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		// Pie 4
		model = glm::translate(model, glm::vec3(0.5f, -0.5f, 1.0f));
		//model = glm::rotate(model, glm::radians(mainWindow.getarticulacion11()), glm::vec3(0.0f, 0.0f, 1.0f)); // Nueva articulación para rotar el pie
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.5f, 1.0f, 0.3f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.8f, 0.8f);
		...
		model = glm::scale(model, glm::vec3(1.0f, 1.5f, 1.0f)); // Escalar laoreja
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.5f, 0.5f, 0.5f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		...
		//canasta
		//modelaux = model;
		model = glm::scale(model, glm::vec3(1.5f, 1.5f, 1.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.0f, 0.8f, 0.8f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
